 ...
 * @author pc
 */
public class SortByAmount extends javax.swing.JFrame {
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(SortByAmount.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
